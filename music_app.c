...
// To delete an undesirable song from the playlist
void Delete_element(){
    if(head==NULL){
...
// To access song at a specific location
void specific_data(){
    if(head==NULL){
